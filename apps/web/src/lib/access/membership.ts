...
import { getWorkspaceMembership, listWorkspaceMemberships } from '../workspace-membership'
...
export async function hasAnyActiveWorkspaceMembership(userId: string): Promise<boolean> {
