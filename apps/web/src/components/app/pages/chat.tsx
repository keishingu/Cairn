...
export const PageChat = ({ isMobile = false }: { isMobile?: boolean }) => {
  ...
  const channelName = currentChannel ? (currentChannel.milestoneId ? `${currentChannel.projectTitle} / ${currentChannel.channelName}` : currentChannel.projectTitle) : currentGeneral?.name ?? currentDm?.participantName ?? ''
