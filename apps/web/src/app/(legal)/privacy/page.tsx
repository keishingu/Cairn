  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          アカウントは、ログイン後の「設定」→「アカウント」→「アカウントを削除」から削除できます。削除すると、認証情報、プロフィール上の個人情報、外部サービス連携、通知先、本人が投稿したメッセージ、写真、添付ファイル、ギャラリーコメントおよび個人のAI会話を削除し、すべてのワークスペースへのアクセスを失効させます。
        </p>
        <p>
          プロジェクトやタスクなど、他の利用者との共同作業を成立させるために必要な構造および法令上保持が必要な記録は、元の氏名、メールアドレス、プロフィール画像等から個人を識別できない「退会済みユーザー」名義へ匿名化したうえで保持する場合があります。バックアップ等の複製は通常の更新周期に従って削除されます。
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <ul>
        ...
        <li>設定画面からアカウントと関連データを削除できます</li>
        <li>お問い合わせ窓口から、情報の開示、訂正、利用停止等を申請できます</li>
      </ul>
    ),
  },
  {
