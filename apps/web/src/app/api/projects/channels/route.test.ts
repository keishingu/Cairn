...
describe('GET /api/projects/channels', () => {
  ...
  it('ゲストは参加プロジェクトのチャンネルのみ取得できる', async () => {
    const channelRow = { channelId: CH_1, channelName: 'general', projectId: PROJ_1, projectTitle: 'プロジェクト1', startDate: null, endDate: null, archived: false, milestoneId: null, milestoneCompleted: null }
  ...
  it('通常メンバーはすべてのプロジェクトのチャンネルを取得できる', async () => {
    const ch1 = { channelId: CH_1, channelName: 'general', projectId: PROJ_1, projectTitle: 'プロジェクト1', startDate: null, endDate: null, archived: false, milestoneId: null, milestoneCompleted: null }
    const ch2 = { channelId: CH_2, channelName: 'general', projectId: PROJ_2, projectTitle: 'プロジェクト2', startDate: null, endDate: null, archived: false, milestoneId: null, milestoneCompleted: null }
